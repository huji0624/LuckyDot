...
bool GameOverScene::initDict(cocos2d::CCDictionary *dic)
{
    ...
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("chime.mp3");
...
//    this->addChild(name);
    ...
    auto replay = ui::Button::create("blue.png");
    ...
    auto share = LHShareButton::defaultButton("green.png",StringUtils::format("%s%d%s",LHLocalizedCString("sharepre"),score->getValue(),LHLocalizedCString("shareend")).c_str());
